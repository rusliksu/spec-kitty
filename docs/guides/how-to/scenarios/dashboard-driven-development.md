...
description: Run delivery from the Spec Kitty kanban dashboard as the single source of truth for a product trio of product manager, designer, and tech lead.
doc_status: active
updated: '2026-08-10'
type: how-to
