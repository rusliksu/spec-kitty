...
- docs/changelog/2x/model-to-task_type.md
---
...
4. Doctrine artifacts already provide governance hooks (directives, toolguides) for 2.x (`docs/changelog/2x/doctrine-and-charter.md`).
