...
- [ ] T001 Add failing registry and current-lock bootstrap acceptance tests.
- [ ] T002 Commit the RED acceptance boundary separately.
- [ ] T003 Add the single legacy-to-canonical retirement mapping.
- [ ] T004 Filter retired aliases from default canonical discovery.
- [ ] T005 Run targeted pytest, ruff, and mypy gates.
- [ ] T006 Build and inspect a wheel; run bootstrap against an isolated profile.
